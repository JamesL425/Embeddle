...
const TEXT = {
    ...
    modals: {
        ...
        cancel: 'CANCEL',
        callsign: '// CALLSIGN',
        callsignDesc: 'Pick a unique callsign for your operative profile. This will be displayed to other players instead of your Google account name.',
        callsignPlaceholder: 'Enter callsign...',
        callsignRules: '3-20 characters. Letters, numbers, underscores, and hyphens only.',
        confirmCallsign: '> CONFIRM CALLSIGN',
        skipForNow: 'Skip for now',
        enterCallsign: '// ENTER_CALLSIGN',
        enterCallsignDesc: 'Choose a callsign to identify yourself in the game.',
        continue: '> CONTINUE',
    },
